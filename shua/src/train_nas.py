...
model = keras.applications.nasnet.NASNetMobile(input_shape=(size, size, 1), alpha=1., weights=None, classes=NCATS)
...
callbacks = [
	...
	ModelCheckpoint('model_nas.h5', monitor='val_top_3_accuracy', mode='max', save_best_only=True,
